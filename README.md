# SMU CS302-DonDonDevOps (G1T8, Team DonDonDonki / Team International Chefs)
A Web Application for Point-of-Sales Transactions in Retail Stores, built using the Microservices Architecture for the Singapore Management University's (SMU) CS302 - Information Technology Lifecycle Management (DevOps) Module Project Submission (G1T8).
